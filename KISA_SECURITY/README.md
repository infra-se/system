...
1. **25년 3월 28일자 기준 23개 취약점 항목에 대해서 자동화 조치 구현 완료**하였고, 지속적으로 Code 추가/구현 중에 있습니다. 
...
따라서 U-06 취약점 항목과 같은 소유주가 없는 파일에 대한 식별 및 삭제 조치를 취하는 항목의 실행에 대해서는 신중을 기해야하며, 본 Script에서도 U-06 취약항목에 대해서는 직접 파일 삭제를 하지 않고, 내역 표기 및 경고처리를 하도록 Logic이 구현 되어있음.)  
