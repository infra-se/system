...
USER_DEFINE_SCRIPT_PATH=/home/${ANSIBLE_ACCOUNT}/ANSIBLE_SCRIPT/USER_DEFINE_SCRIPT
ANSIBLE_RAW_LOG=/tmp/user_define_script.log
ANSIBLE_RESULT=/home/${ANSIBLE_ACCOUNT}/ANSIBLE_SCRIPT/logs/user_define_script.log
RUN_SCRIPT=$1
